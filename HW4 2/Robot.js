...
class Robot extends gNode {
  constructor(parent, size, location, orientation, speed) {
    ...
    //head
    var head = new Box(this, 80*this._size, 60*this._size, 50*this._size, "#63C6FF");
    head.setTransform(m4.translation([0,135*this._size,0]));
    this.addNode("head", head);

    //legs
    var leftLeg = new Box(this, 30*this._size, 100*this._size, 50*this._size, "#63C6FF");
    ...
    var rightLeg = new Box(this, 30*this._size, 100*this._size, 50*this._size, "#63C6FF");
    ...
    //arms
    var leftArm = new Box(this, 30*this._size, 100*this._size, 50*this._size, "#63C6FF");
    ...
    var rightArm = new Box(this, 30*this._size, 100*this._size, 50*this._size, "#63C6FF");
