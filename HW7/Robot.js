...
class Robot extends AbstractNode {
  constructor(parent, id, shader, size, location, orientation, speed) {
    ...
    var body = new Box(this, "body", shader, 100*this._size, 100*this._size, 50*this._size, "#8B0000");
    this.addNode("body", body);

    //head
    var head = new Box(this, "head", shader, 80*this._size, 60*this._size, 50*this._size, "#FFFFFF");
    head.setTransform(m4.translation([0,135*this._size,0]));
    this.addNode("head", head);

    //legs
    var leftLeg = new Box(this, "leftLeg", shader, 30*this._size, 100*this._size, 50*this._size, "#63C600");
    ...
    var rightLeg = new Box(this, "rightLeg", shader, 30*this._size, 100*this._size, 50*this._size, "#63C600");
    ...
    //arms
    var leftArm = new Box(this, "leftArm", shader, 30*this._size, 100*this._size, 50*this._size, "#00C6FF");
    ...
    var rightArm = new Box(this, "rightArm", shader, 30*this._size, 100*this._size, 50*this._size, "#00C6FF");
